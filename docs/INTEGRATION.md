...
jobs:
  shared-lint:
    uses: wiseai-oneplat/wiseai-lint-configs/.github/workflows/reusable-lint.yml@v0.4.5
    with:
...
jobs:
  ai-review:
    uses: wiseai-oneplat/wiseai-lint-configs/.github/workflows/reusable-ai-review.yml@v0.4.5
    with:
